...
from .views import (
    test_view, superuser_test_view, blacklist_test_view, obtain_jwt_token_custom_issuer,
    verify_jwt_token_custom_issuer, refresh_jwt_token_custom_issuer,
)
...
urlpatterns = [
    ...
    url(r"^auth/custom-issuer/$", obtain_jwt_token_custom_issuer, name="auth-custom"),
    url(r"^auth/custom-issuer/verify/$", verify_jwt_token_custom_issuer, name="auth-custom-verify"),
    url(r"^auth/custom-issuer/refresh/$", refresh_jwt_token_custom_issuer, name="auth-custom-refresh"),
